...
const formm = document.getElementById('resume') as HTMLFormElement;
const Display = document.getElementById('display') as
HTMLDivElement;

const shareable = document.getElementById('Shareable-link-container') as HTMLDivElement;

const Links = document.getElementById('link') as
HTMLAnchorElement;
const downloadPdf = document.getElementById('download-pdf') as
HTMLButtonElement;
